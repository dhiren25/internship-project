...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $filterProductId = $_POST['filter_product_id'];
    $filterStatus = $_POST['filter_status'];
    
    // Construct the SQL query with filters
    $sql = "SELECT * FROM `order` WHERE `email` LIKE '%$filterEmail%' AND `product_id` LIKE '%$filterProductId%' AND `status` LIKE '%$filterStatus%'";
} else {
...
if (!$result) {
        ...
        <div class="card-body">
            <form method="post">
                <div class="row gx-3 gy-2 align-items-center">
                    ...
                    <div class="col-12 col-sm-6 col-md-2 col-lg-2 col-xl-2">
                        <div class="form-group mb-3 mb-md-0">
                            <input class="form-control" type="text" name="filter_product_id" placeholder="Enter Product Id" value="<?php echo $filterProductId; ?>">
                        </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-2 col-lg-2 col-xl-2">
                        <div class="form-group mb-3 mb-md-0">
                            <select class="select2 form-select"  name="filter_status">
                                
                                <option <?php if ($filterStatus == "Pending") echo 'selected'; ?>>Pending</option>
                                <option <?php if ($filterStatus == "Delivered") echo 'selected'; ?>>Delivered</option>
                            </select>
                        </div>
                    </div>
                            ...
                            if (mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href='#?id=<?php echo $row["product_id"]; ?>'>Edit</a> |
    ...
    <!-- Add your footer and script tags here if needed -->
    </body>
    </html>
    <?php
}
