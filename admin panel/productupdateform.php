  ...
  <body>
    <?php
     ...
     if (isset($_GET['id'])) {
      ...
      $sql = "SELECT * FROM `product` WHERE `index`= $id";
          ...
          <!-- / Navbar -->
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <!-- Pagination End -->
                    <form action="PUForm_backend.php" method="post"  enctype="multipart/form-data">
                    <div class="card">
                                ...
                                <div class="col-md-8 col-xl-9">
                                    <div class="franchise-form-div">
                                        <div class="form-box mb-3">
                                            <h6 class="mb-3">Upadte Your Product Details</h6>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label">Watch Name<small class="text-danger">*</small></label>
                                                        <input type="text" id="wname" name="wname" class="form-control" value="<?php echo $watch_name; ?>"  placeholder="Watch Name" require>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="color" name="color" value="<?php echo $color; ?>" class="form-control" placeholder="Color" require>
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <input type="text"id="price" name="price" value="<?php echo $price; ?>" class="form-control" placeholder="Price" require>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <input type="text" id="brand" name="brand" value="<?php echo $brand; ?>" class="form-control" placeholder="Brand" require>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                <div class="mb-3">
                                                        <label class="form-label">Date of product Add<small class="text-danger">*</small></label>
                                                        <input type="Date" id="date" name="date" value="<?php echo $date; ?>" class="form-control" placeholder="<?php echo $date; ?>" require>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <input type="text" id="dialcolor" name="dialcolor" value="<?php echo $dialcolor; ?>" class="form-control" placeholder="dialcolor" require>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <option value="<?php echo $dialglassmaterial; ?>"> <?php echo $dialglassmaterial; ?></option>
                                                            ...
                                                            <option value="Watch Display">  Watch Display</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <option value="<?php echo $caseshape; ?>"> <?php echo $caseshape; ?></option>
                                                            <option value="Round">Round</option>
                                                            <option value="Squer">Squer</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <option value="<?php echo $casematerial; ?>"> <?php echo $casematerial; ?></option>
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <input type="number" id="casediameter" name="casediameter" value="<?php echo $casediameter; ?>" class="form-control" placeholder="casesiameter" require>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <input type="text" id="bandcolor" name="bandcolor" value="<?php echo $bandcolor; ?>" class="form-control" placeholder="bandcolor" require>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <option value="<?php echo $bandmaterial; ?>"> <?php echo $bandmaterial; ?></option>
                                                            <option value="Faux leather">Faux leather</option>
                                                            <option value="Genuine leathe">Genuine leathe</option>
                                                            <option value="Full-grain leather"> Full-grain leather</option>
                                                            <option value="Nylon Banding Strap">Nylon Banding Strap</option>
                                                            <option value="Silicone Band">Silicone Band</option>
                                                            <option value="Ceramic watch Band">Ceramic watch Band</option>
                                                            <option value="Mesh Watch Band">Mesh Watch Band</option>
                                                            <option value="Titanium watch Band">Titanium watch Band</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3">
                                                        ...
                                                        <input type="text"  class="form-control" name="description" placeholder="Update Old Description " value="<?php echo $description; ?>" id="description" cols="5" rows="3">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="submit-btn-div justify-content-center d-flex">
                                            <button href="" class="btn btn-primary btn-lg w-75">UPDATE</button>
                                        </div>
                                    </div>
                                </div>
                        </div>
